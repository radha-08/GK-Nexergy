...
const CTABand = ({
    ...
    <section className="relative overflow-hidden bg-ink dark:bg-abyss" data-testid="cta-band">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-8 sm:py-24">
            <Reveal>
                <h2 className="max-w-3xl font-display text-2xl font-extrabold tracking-tight text-white sm:text-4xl lg:text-5xl">
                    {title}
                </h2>
            </Reveal>
            <Reveal delay={0.12}>
                <p className="mt-4 sm:mt-5 max-w-2xl text-sm sm:text-base leading-relaxed text-slate-300 sm:text-lg">{text}</p>
            </Reveal>
            <Reveal delay={0.22}>
